 ...
 * This object collects statistics of the simulation,
 * determines when to open new registers, send new customers to the store
 * and is able to print statistics with its toString method.
 */
